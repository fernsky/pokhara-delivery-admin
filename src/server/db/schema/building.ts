...
export const stagingBuildings = pgTable("staging_product_buildings", {
...
export const buildings = pgTable("product_buildings", {
  id: varchar("id", { length: 48 }).primaryKey(), // Unique identifier for the record
  surveyDate: timestamp("survey_date"),
  enumeratorName: varchar("enumerator_name", { length: 255 }),
...
export const buildingEditRequests = pgTable("product_building_edit_requests", {
...
export const buildingTokens = pgTable("product_building_tokens", {
