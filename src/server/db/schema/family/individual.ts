...
export const stagingproductIndividual = pgTable("staging_product_individual", {
...
export const productIndividual = pgTable("product_individual", {
...
export type productIndividual = typeof productIndividual.$inferSelect;
export type StagingproductIndividual =
  typeof stagingproductIndividual.$inferSelect;
