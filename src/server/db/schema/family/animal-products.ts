...
export const stagingproductAnimalProduct = pgTable(
...
export const productAnimalProduct = pgTable("product_animal_product", {
  id: varchar("id", { length: 48 }).primaryKey().notNull(),
...
export type productAnimalProduct = typeof productAnimalProduct.$inferSelect;
export type StagingproductAnimalProduct =
  typeof stagingproductAnimalProduct.$inferSelect;
