...
export const stagingFamily = pgTable("staging_product_family", {
...
export const family = pgTable("product_family", {
  id: text("id").primaryKey().notNull(),
...
export const familyEditRequests = pgTable("product_family_edit_requests", {
