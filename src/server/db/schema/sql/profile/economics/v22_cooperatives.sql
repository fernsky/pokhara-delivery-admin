...
BEGIN
    ...
    (gen_random_uuid(), 'लिखु पिके बहुउद्देश्यीय स. सं लि', 3, 'MULTI_PURPOSE', '9848102221', ''),
    (gen_random_uuid(), 'जनता दुग्घ सहकारी सं लि.', 3, 'DAIRY', '9858024167', 'प्रदेश स्तरीय'),
    (gen_random_uuid(), 'सहकारी संस्था लि. लिखु पिके', 3, 'OTHER', '9848052947', 'प्रदेश स्तरीय'),
    ...
    (gen_random_uuid(), 'लिखु पिके सैनिकी सहकारी सं लि.', 4, 'OTHER', '9858035240', 'प्रदेश स्तरीय'),
