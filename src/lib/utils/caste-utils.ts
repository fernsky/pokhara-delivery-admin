...
export function generateCasteAnalysis(data: ProcessedCasteData): string {
  ...
  analysisParts.push(
    `जातीय एकता र सामाजिक न्यायको आधारमा समग्र विकास हासिल गर्न महानगरपालिकादृढ संकल्पित छ। सबै जातजातिको सांस्कृतिक पहिचान र मौलिकताको संरक्षण गर्दै आर्थिक समृद्धि र सामाजिक न्यायमा आधारित समाजको निर्माण गर्ने लक्ष्य राखिएको छ। जातीय भेदभावको पूर्ण अन्त्य गरी मानवीय गरिमा र समानताको आधारमा सबै नागरिकहरूको कल्याणमा महानगरपालिकानिरन्तर कार्यरत रहनेछ। विविधतामा एकताको सिद्धान्त अनुसार सबै जातजातिले मिलेर गाउँपालिकाको समग्र विकासमा योगदान पुर्याउने परम्परालाई निरन्तरता दिने प्रतिबद्धता व्यक्त गरिएको छ।`
  );
