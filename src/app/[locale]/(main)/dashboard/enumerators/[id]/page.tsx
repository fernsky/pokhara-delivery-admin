...
import { NepaliIdCard } from "@/app/[locale]/(main)/account/_components/nepali-id-card";
import { UserAvatarUpload } from "@/app/[locale]/(main)/account/_components/user-avatar-upload";
