...
export function MediaSection({ locationId, initialMedia }: MediaSectionProps) {
  ...
  const handleFileUploadComplete = (fileData: any) => {
    ...
    // Just need to associate it with the location - this is now done in the upload procedure
    addMedia({
