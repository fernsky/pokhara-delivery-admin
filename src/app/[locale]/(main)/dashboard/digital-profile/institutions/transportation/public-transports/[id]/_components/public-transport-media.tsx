...
import { Image, X, FileText, Video, FileImage, Bus } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { api } from "@/trpc/react";
import { useRouter } from "next/navigation";
import { toast } from "sonner";

interface PublicTransportMediaProps {
  transportId: string;
  media: any[];
}

export function PublicTransportMedia({
  transportId,
  media,
}: PublicTransportMediaProps) {
