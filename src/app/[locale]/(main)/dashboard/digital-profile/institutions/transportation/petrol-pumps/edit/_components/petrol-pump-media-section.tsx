...
interface PetrolPumpMediaSectionProps {
  petrolPumpId: string;
  existingMedia: MediaFile[];
}

export function PetrolPumpMediaSection({
  petrolPumpId,
  existingMedia,
}: PetrolPumpMediaSectionProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>पेट्रोल पम्पको फोटोहरू</CardTitle>
        <CardDescription>
          पेट्रोल पम्पको फोटोहरू अपलोड वा व्यवस्थापन गर्नुहोस्
        </CardDescription>
      </CardHeader>
