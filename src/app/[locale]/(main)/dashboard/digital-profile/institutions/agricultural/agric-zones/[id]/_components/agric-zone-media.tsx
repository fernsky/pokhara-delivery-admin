...
interface AgricZoneMediaProps {
  agricZoneId: string;
  media: any[];
}

export function AgricZoneMedia({ agricZoneId, media }: AgricZoneMediaProps) {
          ...
          {media.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-sm mt-2">
                कृषि क्षेत्रको फोटोहरू संलग्न गर्न सम्पादन पृष्ठमा जानुहोस्
              </p>
            </div>
          ) : (
