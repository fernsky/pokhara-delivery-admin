...
export default function ImportedProductsTable({
  data,
  onEdit,
  ...
  const deleteImportedProduct =
    api.profile.economics.importedProducts.delete.useMutation({
      onSuccess: () => {
  ...
  const handleDelete = () => {
    if (deleteId) {
      deleteImportedProduct.mutate({ id: deleteId });
      setDeleteId(null);
    }
  };
