    ...
    <>
      ...
      <div className="bg-muted/50 p-4 rounded-lg mt-8">
        <h3 className="text-xl font-medium mb-4">
          ...
          <span className="sr-only">
            Religious Diversity Analysis of Pokhara
          </span>
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-card p-4 rounded border">
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Main Religion in Pokhara Metropolitan City
              </span>
            </h4>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                {topReligion
                  ? `${((topReligion.population / totalPopulation) * 100).toFixed(2)}% of total population in Pokhara Metropolitan City`
                  : ""}
              </span>
            </p>
          </div>
          ...
          <div className="bg-card p-4 rounded border">
            <h4 className="font-medium mb-2">
              ...
              <span className="sr-only">
                Primary to Secondary Religion Ratio in Pokhara
              </span>
            </h4>
            <p className="text-3xl font-bold">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              ...
              <span className="sr-only">
                {topReligion && secondReligion
                  ? `For every ${topTwoReligionRatio} ${topReligion.religion.toLowerCase()} followers, there is 1 ${secondReligion.religion.toLowerCase()} follower in Pokhara Metropolitan City`
                  : ""}
              </span>
            </p>
          </div>
