  ...
  const generateStructuredData = () => {
    ...
    const accessStats = wardNumbers
      .map((wardNumber) => {
        ...
        return {
          "@type": "Observation",
          name: `Market Center Access Statistics in Ward ${wardNumber} of Pokhara Metropolitan City`,
          ...
          description: `In Ward ${wardNumber} of Pokhara Metropolitan City, ${quickAccessHouseholds.toLocaleString()} households (${quickAccessPercent}%) can access market centers within 30 minutes out of a total of ${totalWardHouseholds.toLocaleString()} households.`,
        };
      })
      .filter(Boolean);
