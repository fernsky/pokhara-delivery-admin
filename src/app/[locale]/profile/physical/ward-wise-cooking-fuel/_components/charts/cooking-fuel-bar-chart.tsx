...
interface CookingFuelBarChartProps {
...
export default function CookingFuelBarChart({
  wardWiseData,
  COOKING_FUEL_CATEGORIES,
}: CookingFuelBarChartProps) {
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Legend
          ...
          align="center"
        />
        {Object.values(COOKING_FUEL_CATEGORIES).map((category, index, arr) => (
          <Bar
            key={category.name}
