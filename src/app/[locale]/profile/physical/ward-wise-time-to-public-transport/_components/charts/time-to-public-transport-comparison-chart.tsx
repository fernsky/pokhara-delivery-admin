...
interface TimeToPublicTransportComparisonChartProps {
...
export default function TimeToPublicTransportComparisonChart({
  wardWiseQuickAccess,
  bestAccessWard,
  worstAccessWard,
  TIME_CATEGORIES,
}: TimeToPublicTransportComparisonChartProps) {
