...
interface ElectricitySourceBarChartProps {
...
export default function ElectricitySourceBarChart({
  wardWiseData,
  ELECTRICITY_SOURCE_CATEGORIES,
}: ElectricitySourceBarChartProps) {
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Legend
          ...
          align="center"
        />
        {Object.values(ELECTRICITY_SOURCE_CATEGORIES).map((category, index, arr) => (
          <Bar
            key={category.name}
