...
interface DrinkingWaterSourceBarChartProps {
...
export default function DrinkingWaterSourceBarChart({
  wardWiseData,
  WATER_SOURCE_GROUPS,
}: DrinkingWaterSourceBarChartProps) {
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Legend
          ...
          align="center"
        />
        {Object.values(WATER_SOURCE_GROUPS).map((group, index, arr) => (
          <Bar
            key={group.name}
            dataKey={group.name}
            name={group.name}
