...
export default function SpicePieChart({
  pieChartData,
  SPICE_TYPES,
  SPICE_COLORS,
  dataType,
      ...
      <PieChart>
        ...
        >
          {pieChartData.map((entry, index) => {
            // Find the original spice type key for color mapping
            const spiceKey =
              Object.entries(SPICE_TYPES).find(
            ...
            return (
              <Cell
                key={`cell-${index}`}
                fill={
                  SPICE_COLORS[spiceKey as keyof typeof SPICE_COLORS] ||
