...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const descriptionEN = `Detailed analysis of ${totalGroups} agriculture related farmers groups operating in Khajura metropolitan city. Ward ${wardWithMostGroups} has the highest concentration with ${wardMaxCount} active groups. Comprehensive information on municipality-wide agricultural groups.`;
        ...
        <section>
          <div className="relative rounded-lg overflow-hidden mb-8">
            <Image
              ...
              width={1200}
              height={400}
              alt="कृषि सम्बन्धित समूहहरू - पोखरा महानगरपालिका (Agriculture Related Farmers Groups - Khajura metropolitan city)"
