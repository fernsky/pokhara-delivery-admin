...
export default function FarmersGroupAnalysisSection({
  ...
  return (
    <>
      ...
      <p className="mt-4">
        पोखरा महानगरपालिकाका कृषि सम्बन्धित समूहहरूले कृषि उत्पादन, बजारीकरण र
      ...
      <div className="bg-muted/50 p-6 rounded-lg mt-8 border">
        <h3 className="text-xl font-medium mb-6">
          ...
          <span className="sr-only">
            Detailed Agriculture Related Groups Analysis of Pokhara
          </span>
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-card p-4 rounded border">
            <h4 className="font-medium mb-2">
              प्रमुख समूह प्रकार
              <span className="sr-only">
                Main Group Types in Pokhara Metropolitan City
              </span>
            </h4>
            {primaryGroup && (
        ...
        <div className="mt-6 pt-4 border-t">
          ...
          <p className="text-sm">
            पोखरा महानगरपालिकामा सञ्चालित कृषि सम्बन्धित समूहहरूले स्थानीय
