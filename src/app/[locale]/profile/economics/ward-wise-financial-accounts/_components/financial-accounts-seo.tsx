  ...
  const generateStructuredData = () => {
    ...
    const financialAccountStats = wardNumbers
      .map((wardNumber) => {
        ...
        return {
          "@type": "Observation",
          name: `Financial Account Statistics in Ward ${wardNumber} of Pokhara Metropolitan City`,
          ...
          description: `In Ward ${wardNumber} of Pokhara Metropolitan City, ${bankAccount.toLocaleString()} households (${bankAccountPercent}%) have bank accounts out of a total of ${totalWardHouseholds.toLocaleString()} households.`,
        };
      })
      .filter(Boolean);
