...
export default function IrrigatedAreaSEO({
  ...
  const generateStructuredData = () => {
    ...
    const wardIrrigatedStats = wardData.map((ward) => ({
      "@type": "Observation",
      name: `Ward ${ward.wardNumber} Irrigated Area in Pokhara Metropolitan City`,
