...
interface ExportedProductsSearchBarProps {
...
export default function ExportedProductsSearchBar({
  exportedProductsData,
}: ExportedProductsSearchBarProps) {
  const [searchTerm, setSearchTerm] = useState("");
  const [searchResults, setSearchResults] = useState<
    typeof exportedProductsData
  >([]);
  ...
  const handleSearch = () => {
    ...
    const results = exportedProductsData.filter((product) =>
