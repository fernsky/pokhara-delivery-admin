...
interface LoanUsageBarChartProps {
  wardWiseData: Array<Record<string, any>>;
  LOAN_USE_COLORS: Record<string, string>;
  loanUseLabels: Record<string, string>;
}

export default function LoanUsageBarChart({
  wardWiseData,
  LOAN_USE_COLORS,
  loanUseLabels,
}: LoanUsageBarChartProps) {
  return (
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Legend
          ...
          align="center"
        />
        {/* Dynamically generate bars based on available loan uses in wardWiseData */}
        {Object.keys(
          wardWiseData.reduce(
            (acc, ward) => {
          ...
          // Find the loan use key for color mapping
          const loanUseKey =
            Object.keys(loanUseLabels).find(
              (key) => loanUseLabels[key] === loanUse,
            ) || "OTHER";
