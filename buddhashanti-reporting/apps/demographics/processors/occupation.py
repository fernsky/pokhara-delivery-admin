...
class OccupationProcessor(BaseDemographicsProcessor, SimpleChartProcessor):
    ...
    class OccupationReportFormatter(BaseReportFormatter):
        ...
        def generate_formal_report(self, occupation_data, ward_data, total_population):
            ...
            content.append(
                """सबै पेशामा संलग्न व्यक्तिहरूको सामाजिक सुरक्षा र श्रमिक अधिकारको संरक्षणमा महानगरपालिकाप्रतिबद्ध छ । कार्यक्षेत्रको सुरक्षा, उचित पारिश्रमिक र सामाजिक सुरक्षाका कार्यक्रमहरू सञ्चालन गरिएको छ ।"""
            )
